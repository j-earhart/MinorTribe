...
namespace MinorTribe.Controllers
{
    public class ContactsController : Controller
    {
        ...
        public ContactsController(MinorTribeContext context)
        {
            _context = context;
        }
        ...
        {
            var minorTribeContext = _context.Contacts.Include(c => c.States);
        ...
        public async Task<IActionResult> Create([Bind("Id,Email,City,StateId")] Contact contact)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Email,City,StateId")] Contact contact)
        {
            if (id != contact.Id)
            {
                return NotFound();
